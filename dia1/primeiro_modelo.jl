...
# ╔═╡ 4d689eda-5e1d-496c-a551-50b2ec6076fd
md"## Primeiro modelo"

# ╔═╡ 2b9f6c13-9df3-4bf0-a604-905b88efaee0
modelo = Model(HiGHS.Optimizer)

# ╔═╡ 61be416c-0f42-499b-be8a-f4bbd4d09349
@variable(modelo, x >= 0)

# ╔═╡ 0d0cf31f-ded3-4652-b0c5-bfc95f7fe845
@variable(modelo, 0 <= y <= 3)

# ╔═╡ 5c1e6c96-7c7d-4752-a9f3-29c769c9a7df
@constraint(modelo, c1, 6x + 8y >= 100)

# ╔═╡ 27bbb8dc-16d7-44ac-a17c-f41d74a80c01
@constraint(modelo, c2, 7x + 12y >= 120)

# ╔═╡ 37b20df2-0e2f-4d4a-94ec-2f578cb3e572
@objective(modelo, Min, 12x + 20y)

# ╔═╡ 5d41dee3-a1c2-4e94-ae2f-94dd4e71dc0d
# Mostra o modelo
println(modelo)

# ╔═╡ 71cc3e1d-f567-4035-9e3e-b9c41d2c1b0d
optimize!(modelo)

# ╔═╡ 5dd39c64-fbfc-4ee1-bdba-e6ad5e456f4b
begin
...
# ╔═╡ cb809015-aa22-4bb7-839b-32ba11490189
md"## O problema do uso de recursos financeiros"

# ╔═╡ bc2f30bc-c545-4369-88ce-b74f7f2f787c
md"## O problema da cerveja"
