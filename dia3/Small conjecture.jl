...
# ╔═╡ 1722b21e-d644-4a2e-8c79-0d005c08526a
using Plots

# ╔═╡ ef3042e1-eda4-410a-b8ae-49bcbb96d089
# Pacotes e funções úteis:

using LinearAlgebra, JuMP, Ipopt

# ╔═╡ 4ebd458c-cf45-416b-bf88-ebe7dcc660cf
"""
...
# ╔═╡ fd892559-9fdd-48e2-a794-0e90e2b4d689
"""
...
# ╔═╡ de7a6d30-a686-4f91-8944-fc0b69c1188f
"""
...
# ╔═╡ e71078da-296a-4713-a51b-0156801bff9c
"""
...
# ╔═╡ 815c4b04-f9c2-4e74-ad8f-7f192af38317
# ------------------------------------------------------------------------------
...
# ╔═╡ 14d419a0-e61d-4d52-9ee0-c47842f1bcd0
"""
...
# ╔═╡ afff2bf8-0b01-499e-a058-36c9a30a9214
...
# ╔═╡ 96d3d5f3-0417-4a99-963a-ebbb28896162
"""
...
# ╔═╡ 6298bf6c-c891-4e32-9604-4ebc7e6de913
...
# ╔═╡ 61addbc8-0c29-4bbe-b251-68007d3bffd5
...
# ╔═╡ 05504420-bd04-42d9-ad7f-162cda953d81
...
# ╔═╡ d4f7df52-bd27-4769-8868-90f5454a1646
...
# ╔═╡ 5781c942-5afa-46a8-9565-65e0e42a8ccc
#ok
...
# ╔═╡ 8350664d-b24d-42a9-819a-eccd7c5a39ab
#ok
...
# ╔═╡ b2fcfe1c-48bf-4dbf-9de8-d1793430358f
#ok
...
# ╔═╡ e2d788c2-5c45-474a-9ca4-c41334cc1838
#ok    
...
# ╔═╡ d1bc6222-9690-477b-b007-dad4059eb266
...
# ╔═╡ 7cb16900-f8ff-42b0-83a2-1ddb33672a97
function resolve_modelo_fixo(lista_poligonos, circ_r, L, W)
    ...
    return value.(xC), value.(yC), value.(xP), value.(yP), value.(theta_P) 
...
begin
	...
	xcv, ycv, xpv, ypv, tv = resolve_modelo_fixo(lista_poligonos, circ_r, L, W)
	
end

# ╔═╡ 3e0e9f63-e7d2-429a-b496-dde450e8d17c
function desenha(xC_values, yC_values, xP_values, yP_values, theta_P_values)
...
# ╔═╡ f95773ab-29cb-44e3-b147-0e70152b66fd
desenha(xcv, ycv, xpv, ypv, tv)
